...
def generate(state: State):
    ...
    print("context received in generate")
    print(context)

    print("question received in generate")
    print(question)
...
# Generate and save the graph as a PNG
# try:
#     png_data = builder.get_graph().draw_mermaid_png()
#     with open("AdaptiveRAG.png", "wb") as f:
#         f.write(png_data)
#     print("Graph visualization successfully saved to AdaptiveRAG.png")
