...
### 🎨 User Interface
- **React Web App**: Interactive chat interface with document upload
...
- MongoDB (optional; in-memory chat history used by default)
- Qdrant vector database (optional; FAISS used by default)
- OpenAI API key
...
git clone https://github.com/L-A-L-I-T/Adaptive-Rag.git
cd Adaptive-Rag
...
A: Upload one document at a time through the web interface. Each upload creates a new indexed collection.
